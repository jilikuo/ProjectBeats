namespace Jili.StatSystem
{
    ...
    public class StatsModifiers
    {
        ...
        public readonly StatModType Type;   // Tipo do modificador
        ...
        public StatsModifiers(float value, StatModType type, int priority, object source) // CONSTRUTOR DO MODIFICADOR
        {
            Value = value;
            Type = type;
            Priority = priority;
        ...
        public StatsModifiers(float value, StatModType type) : this(value, type, (int)type, null) { }

        public StatsModifiers(float value, StatModType type, int priority) : this(value, type, priority, null) { }

        public StatsModifiers(float value, StatModType type, object source) : this(value, type, (int)type, source) { }
    }
}