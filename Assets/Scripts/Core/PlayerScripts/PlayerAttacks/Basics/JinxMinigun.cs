...
namespace Jili.StatSystem.AttackSystem
{
    ...
    public class JinxMinigun : LootableCard, IShootable
    {
        ...
        private int BaseProjectiles        = 2;                            // UM PROJ�TIL BASE
        private readonly int ProjectileMultiplier   = 1;                            // total de proj�teis � multiplicado por esse valor
        private readonly float MultiProjDmgNerf     = 0.3f;                         // fator de redu��o de dano por proj�til ( x * 0,3)
        ...
        private int Tier = 0;                                                       // N�VEL DA ARMA
        ...
        { 
            get {
                ...
                return (_damage * MultiProjDmgNerf); // o dano do proj�til � 50% do dano do jogador
            }
        }
