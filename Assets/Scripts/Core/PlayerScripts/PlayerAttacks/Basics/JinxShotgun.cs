    ...
    public class JinxShotgun : LootableCard, IShootable
    {
        ...
        { 
            get {
                ...
                return _damage * 0.75f; // o dano do proj�til �
            }
        }
        ...
        // not working
        // spread
        private float _spread;        // dispers�o dos proj�teis
        ...
        public IEnumerator AimProjectiles()
        {
            ...
            float currentAngle = -angleStep * (ProjectileNumber - 1) / 2; // Centraliza os proj�teis

            //atira na dire��o calculada
            for (int i = 0; i < ProjectileNumber; i++)
            {
                // Calcula a nova dire��o com base no �ngulo de rota��o
