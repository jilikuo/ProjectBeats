...
public class EnemyMoveSuicidal : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        // Rotaciona o inimigo para olhar na dire��o do movimento, ajustando para a sprite que olha para baixo
        float angle = Mathf.Atan2(direction.y, direction.x) * Mathf.Rad2Deg;
        // Como a sprite olha para baixo, ajustamos o �ngulo adicionando 90 graus
